<template>
  <div>
    <input type="text" placeholder="Search bookmarks" autocomplete="off" spellcheck="false"
           ...
           class="focus:outline-none text-sm border border-transparent focus:bg-white focus:border-grey-light placeholder-grey-darkest rounded bg-grey-lighter py-2 pr-4 pl-10 block w-full appearance-none leading-normal">
    <div class="absolute pin-y pin-l pl-3 flex items-center" v-if="query">
      <svg class="fill-current text-grey-dark w-5 h-5 cursor-pointer" @click="clearSearch" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
